    ...
    <header className="sticky top-0 z-30 h-16 bg-white/90 dark:bg-[#161922]/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4 transition-colors">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-black dark:bg-white text-white dark:text-black text-xs font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition-all shadow-xs cursor-pointer"
        >
          <Plus size={14} />
